...
export default class MessageWrapper extends React.Component<{}, {message: {open: boolean, text: string|null}}>{
    constructor(props){
        super(props);
        this.state = {
            message: {
    ...
    render(){
        return <React.Fragment>
            <AccessWrapper postMessage={message=>this.postMessage(message)}/>
            <Snackbar
